...
1. **Invoke `feature-dev:code-explorer`** skill for deep codebase analysis:
   - Traces execution paths and maps architecture layers
   - Understands patterns and abstractions
   - Documents dependencies and affected components
